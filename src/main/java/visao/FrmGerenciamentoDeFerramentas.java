...
public class FrmGerenciamentoDeFerramentas extends javax.swing.JFrame {
    ...
    private void JTableFerramentasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_JTableFerramentasMouseClicked
        ...
        if (this.JTableFerramentas.getSelectedRow() != -1) {
            ...
            JLDisponibilidade.setVisible(true);
            ...
            JLDisponibilidade.setText(disponibilidade.equals("true") ? "Disponível" : "Indisponível");
    ...
    private void JBAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_JBAlterarActionPerformed
        ...
        try {
            ...
            if (this.objetoferramenta.updateFerramentaDB(IdFerramentas, NomeFerramentas, MarcaFerramentas,CustoFerramentas)){
                ...
                JLDisponibilidade.setVisible(false);
        ...
        try {
            ...
            if(respostaUsuario == 0) {
                if(this.objetoferramenta.DeleteFerramentaDB(IdFerramentas)){
                    ...
                    this.JLDisponibilidade.setText("0");
...
public void CarregaListaFerramenta(){
    ...
    JLDisponibilidade.setVisible(false); /* Deixa o label que informa a Disponibilidade vazio até que alguma ferramenta seja clicada */
    modelo.setNumRows(0);
